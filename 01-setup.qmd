...
# This is a hidden answer code chunk
# Students can click to reveal it when they need help

# Example of running the script-1.R file
# First, set your working directory to where you saved the file
# setwd("path/to/your/directory")  # Uncomment and modify this line

# Then you can run the script using the source() function
# source("script-1.R")

# Or you can open the file in RStudio and run it line by line
# The script should produce output like:
# [1] 3.8  # Mean of the example data
# [1] 2.167948  # Standard deviation of the example data
```

When you run the script, you should see output in the Console window showing statistical calculations like mean and standard deviation of the example data.
:::
